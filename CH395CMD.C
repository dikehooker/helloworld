...
UINT8 CH395CMDCheckExist(UINT8 testdata)
{
    ...
    xWriteCH395Data(testdata); //0x65 返回数据取反  0xaa
    i = xReadCH395Data();
    return i;
}
...
void CH395CMDSetUartBaudRate(UINT32 baudrate)
{
    ...
    xWriteCH395Data((UINT8)baudrate);	 //00
    xWriteCH395Data((UINT8)((UINT16)baudrate >> 8));   //e1
    xWriteCH395Data((UINT8)(baudrate >> 16));		   //	10
//    xEndCH395Cmd();
}
 */
/*******************************************************************************
